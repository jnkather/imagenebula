function [path] = filtercachepath()
%FILTERCACHEPATH returns the path to the filter cache directory.
%
% PATH = FILTERCACHEPATH()
%
% This function returns the path to the filter cache directory.
%
% OUTPUTS
%  PATH		- The full path to the filter cache directory.
%
