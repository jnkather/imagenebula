function [path] = hsdatapath()
%HSDATAPATH returns the data directory for the UCSD biosegmentation dataset for
% breast cancer detection
%
% PATH = HSDATAPATH()
%
% This function returns the data directory for the UCSD biosegmentaion dataset.
%
% OUTPUTS
%  PATH		- The full path of the data directory.
%
